...
<head>
    ...
    <script>
        ...
        function openPopup() {
            document.getElementById("tambahAssetPopup").style.display = "block";
        }

        // Fungsi untuk menyembunyikan popup
        function closePopup() {
            document.getElementById("tambahAssetPopup").style.display = "none";
        }
    </script>
    <style>
        body {
    ...
    <div class="top-navbar">
        ...
        <div class="center-container">
            <div class="search-container">
                <input type="text" name="search" placeholder="Cari kebutuhan anda...">
    ...
    <div class="dashboard-container">
        ...
        <div class="content-wrapper">
            <div class="content">
                ...
                <a href="javascript:void(0);" onclick="openPopup()" class="tambah-asset-button">
